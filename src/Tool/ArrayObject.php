...
class ArrayObject extends Ancestor
{
     ...
     * @return self
     */
    public function unshiftList(ArrayObject $listObject)
    {
        $this->unshift(...array_values($listObject->getArrayCopy()));
     ...
     * @return self
     */
    public function pushList(ArrayObject $listObject)
    {
        $this->push(...array_values($listObject->getArrayCopy()));
